...
class Model():
    def __init__(self, config):
        ...
        with tf.variable_scope("Encoder") as scope:
            ...
            outputs_enc, _ = tf.contrib.legacy_seq2seq.rnn_decoder(tf.unstack(self.x_exp, axis=2), initial_state_enc,
                                                                   cell_enc)
        ...
        with tf.variable_scope("Decoder") as scope:
            ...
            cell_dec = tf.contrib.rnn.MultiRNNCell([cell_dec] * num_layers)
        ...
        with tf.name_scope("Out_layer") as scope:
            ...
            outputs = tf.reshape(tf.stack(outputs_dec, 0), (-1, hidden_size))  # tensor in [sl*batch_size,hidden_size]
        ...
        with tf.name_scope("train") as scope:
            ...
            tf.summary.scalar("seq_loss", self.loss_seq)
            tf.summary.scalar("lat_loss", self.loss_lat_batch)
